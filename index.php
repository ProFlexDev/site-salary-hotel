...
if (isset($_GET['date'])) {
    ...
    echo "<thead><tr><th>Начало работы</th><th>Конец работы</th><th>Номер комнаты</th><th>Категория комнаты</th><th>Тип уборки</th><th>Полотенце</th><th>Бельё</th><th>Стоимость уборки</th></tr></thead>";
    echo "<tbody>";
    ...
    foreach ($workList as $work) {
        ...
        echo "<td class='th_month_table'></td>";
        echo "<td class='th_month_table'></td>";
